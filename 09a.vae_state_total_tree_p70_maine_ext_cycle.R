...
for(i in 1:nrow(ext_cycle)){
  if(ext_cycle$PANEL_70[i] > 14 & ext_cycle$PANEL_70[i] <= 21){ext_cycle$NEWINVYR_10[i] <- 2020} else 
    if(ext_cycle$PANEL_70[i] > 21 & ext_cycle$PANEL_70[i] <= 28){ext_cycle$NEWINVYR_10[i] <- 2021} else 
      if(ext_cycle$PANEL_70[i] > 28 & ext_cycle$PANEL_70[i] <= 35){ext_cycle$NEWINVYR_10[i] <- 2022} else 
        if(ext_cycle$PANEL_70[i] > 35 & ext_cycle$PANEL_70[i] <= 42){ext_cycle$NEWINVYR_10[i] <- 2023} else 
          if(ext_cycle$PANEL_70[i] > 42 & ext_cycle$PANEL_70[i] <= 49){ext_cycle$NEWINVYR_10[i] <- 2024} else 
            if(ext_cycle$PANEL_70[i] > 49 & ext_cycle$PANEL_70[i] <= 56){ext_cycle$NEWINVYR_10[i] <- 2025} else 
              if(ext_cycle$PANEL_70[i] > 56 & ext_cycle$PANEL_70[i] <= 63){ext_cycle$NEWINVYR_10[i] <- 2026} else
                if(ext_cycle$PANEL_70[i] > 63 & ext_cycle$PANEL_70[i] <= 70){ext_cycle$NEWINVYR_10[i] <- 2027} else
                  if(ext_cycle$PANEL_70[i] > 0 & ext_cycle$PANEL_70[i] <= 7){ext_cycle$NEWINVYR_10[i] <- 2028} else
                    if(ext_cycle$PANEL_70[i] > 7 & ext_cycle$PANEL_70[i] <= 14){ext_cycle$NEWINVYR_10[i] <- 2029} 
}
...
round(props_measured*100,2) # 10.18 / 10.21 / 10.06 / 10.01 / 10.01 / 9.95 / 10.09 / 9.75 / 10.03 / 9.72
...
for(i in 1:nrow(ext_cycle)){
  if(ext_cycle$PANEL_70[i] > 14 & ext_cycle$PANEL_70[i] <= 19){ext_cycle$NEWINVYR_14[i] <- 2020} else 
    if(ext_cycle$PANEL_70[i] > 19 & ext_cycle$PANEL_70[i] <= 24){ext_cycle$NEWINVYR_14[i] <- 2021} else 
      if(ext_cycle$PANEL_70[i] > 24 & ext_cycle$PANEL_70[i] <= 29){ext_cycle$NEWINVYR_14[i] <- 2022} else 
        if(ext_cycle$PANEL_70[i] > 29 & ext_cycle$PANEL_70[i] <= 34){ext_cycle$NEWINVYR_14[i] <- 2023} else 
          if(ext_cycle$PANEL_70[i] > 34 & ext_cycle$PANEL_70[i] <= 39){ext_cycle$NEWINVYR_14[i] <- 2024} else 
            if(ext_cycle$PANEL_70[i] > 39 & ext_cycle$PANEL_70[i] <= 44){ext_cycle$NEWINVYR_14[i] <- 2025} else 
              if(ext_cycle$PANEL_70[i] > 44 & ext_cycle$PANEL_70[i] <= 49){ext_cycle$NEWINVYR_14[i] <- 2026} else
                if(ext_cycle$PANEL_70[i] > 49 & ext_cycle$PANEL_70[i] <= 54){ext_cycle$NEWINVYR_14[i] <- 2027} else
                  if(ext_cycle$PANEL_70[i] > 54 & ext_cycle$PANEL_70[i] <= 59){ext_cycle$NEWINVYR_14[i] <- 2028} else
                    if(ext_cycle$PANEL_70[i] > 59 & ext_cycle$PANEL_70[i] <= 64){ext_cycle$NEWINVYR_14[i] <- 2029} else
                      if(ext_cycle$PANEL_70[i] > 64 & ext_cycle$PANEL_70[i] <= 69){ext_cycle$NEWINVYR_14[i] <- 2030} else
                        if(ext_cycle$PANEL_70[i] == 70){ext_cycle$NEWINVYR_14[i] <- 2031} else
                        if(ext_cycle$PANEL_70[i] > 0 & ext_cycle$PANEL_70[i] <= 4){ext_cycle$NEWINVYR_14[i] <- 2031} else
                          if(ext_cycle$PANEL_70[i] > 4 & ext_cycle$PANEL_70[i] <= 9){ext_cycle$NEWINVYR_14[i] <- 2032} else
                            if(ext_cycle$PANEL_70[i] > 9 & ext_cycle$PANEL_70[i] <= 14){ext_cycle$NEWINVYR_14[i] <- 2033} 
}
...
round(props_measured*100,2) # 7.26 / 7.12 / 7.40 / 7.20 / 7.20 / 7.18 / 7.09 / 7.00 / 7.18 / 7.23 / 7.03 / 7.00 / 7.23 / 6.86
...
colnames(ext_cycle_results) <- c("total_7","se_pct_7", "total_10","se_pct_10", "total_14","se_pct_14")
...
for(i in 1:nsim){
  ...
  ext_cycle$NEWVOL_7 <- ext_cycle$NEWVOL_10 <- ext_cycle$NEWVOL_14 <- 0
  ...
  v_Yhd_new <- aggregate(cbind(ext_cycle$NEWVOL_7,
                               ext_cycle$NEWVOL_10,
                               ext_cycle$NEWVOL_14),
  ...
  colnames(v_Yhd_new)[ncol(v_Yhd_new)-2] <- "VOLCFNET_eu_strat_se_7"
...
plot(ESTIMATED_TOTAL, se_pct, col="red", pch = 19,
     ...
     xaxt = "n",
     main = "Maine")
points(ext_cycle_results$total_7,ext_cycle_results$se_pct_7, pch=19, col = t_blk) # 7 year cycle
...
legend("bottomleft", 
       legend = c("Original Estimate","7 Year Cycle", "10 Year Cycle", "14 Year Cycle"), 
