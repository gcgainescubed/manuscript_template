...
# P70 values are staggered off of the INVYRS  2020-2024 by one panel... 
# I.e., 2020 = P70 15 - 28, etc...
...
#   if(ext_cycle$PANEL_70[i] > 14 & ext_cycle$PANEL_70[i] <= 24){ext_cycle$NEWINVYR_7[i] <- 2020} else 
#     if(ext_cycle$PANEL_70[i] > 24 & ext_cycle$PANEL_70[i] <= 34){ext_cycle$NEWINVYR_7[i] <- 2021} else 
#       if(ext_cycle$PANEL_70[i] > 34 & ext_cycle$PANEL_70[i] <= 44){ext_cycle$NEWINVYR_7[i] <- 2022} else 
#         if(ext_cycle$PANEL_70[i] > 44 & ext_cycle$PANEL_70[i] <= 54){ext_cycle$NEWINVYR_7[i] <- 2023} else 
#           if(ext_cycle$PANEL_70[i] > 54 & ext_cycle$PANEL_70[i] <= 64){ext_cycle$NEWINVYR_7[i] <- 2024} else 
#             if(ext_cycle$PANEL_70[i] > 64 & ext_cycle$PANEL_70[i] <= 70){ext_cycle$NEWINVYR_7[i] <- 2025} else 
#               if(ext_cycle$PANEL_70[i] > 0 & ext_cycle$PANEL_70[i] <= 4){ext_cycle$NEWINVYR_7[i] <- 2025} else # had to add this because it wouldn't let me span 0???
#                 if(ext_cycle$PANEL_70[i] > 4 & ext_cycle$PANEL_70[i] <= 14){ext_cycle$NEWINVYR_7[i] <- 2026} 
# }

### 5 year cycle length: 14 P70's/INVYR
ext_cycle$NEWINVYR_5 <- 0
for(i in 1:nrow(ext_cycle)){
  if(ext_cycle$PANEL_70[i] > 2 & ext_cycle$PANEL_70[i] <= 16){ext_cycle$NEWINVYR_5[i] <- 2013} else # slow: 8 P70's
    if(ext_cycle$PANEL_70[i] > 16 & ext_cycle$PANEL_70[i] <= 30){ext_cycle$NEWINVYR_5[i] <- 2014} else # slow: 8 P70's
      if(ext_cycle$PANEL_70[i] > 0 & ext_cycle$PANEL_70[i] <= 2){ext_cycle$NEWINVYR_5[i] <- 2015} else
      if(ext_cycle$PANEL_70[i] > 30 & ext_cycle$PANEL_70[i] <= 42){ext_cycle$NEWINVYR_5[i] <- 2015} else # slow: 8 P70's
        if(ext_cycle$PANEL_70[i] > 42 & ext_cycle$PANEL_70[i] <= 56){ext_cycle$NEWINVYR_5[i] <- 2016} else # fast:
          if(ext_cycle$PANEL_70[i] > 56 & ext_cycle$PANEL_70[i] <= 70){ext_cycle$NEWINVYR_5[i] <- 2017}  # fast: 12 P70's
}
...
round(props_measured*100,2) # 14.38 / 14.61 / 14.38 / 14.09 / 14.41 / 14.04 / 14.09
...
ext_cycle$INVDIFF_5 <- ifelse(ext_cycle$INVDIFF_5 < (-2), -2, ext_cycle$INVDIFF_5)
ext_cycle$INVDIFF_5 <- ifelse(ext_cycle$INVDIFF_5 > 0, 0, ext_cycle$INVDIFF_5)

table(ext_cycle$INVDIFF_5,useNA = "always") 

### Ten year cycle length: 7 P70's/INVYR
table(plots_p70$INVYR,plots_p70$PANEL_70)

ext_cycle$NEWINVYR_10 <- 0
for(i in 1:nrow(ext_cycle)){
  if(ext_cycle$PANEL_70[i] > 2 & ext_cycle$PANEL_70[i] <= 9){ext_cycle$NEWINVYR_10[i] <- 2013} else 
    if(ext_cycle$PANEL_70[i] > 9 & ext_cycle$PANEL_70[i] <= 16){ext_cycle$NEWINVYR_10[i] <- 2014} else 
      if(ext_cycle$PANEL_70[i] > 16 & ext_cycle$PANEL_70[i] <= 23){ext_cycle$NEWINVYR_10[i] <- 2015} else 
        if(ext_cycle$PANEL_70[i] > 23 & ext_cycle$PANEL_70[i] <= 30){ext_cycle$NEWINVYR_10[i] <- 2016} else 
          if(ext_cycle$PANEL_70[i] > 30 & ext_cycle$PANEL_70[i] <= 32){ext_cycle$NEWINVYR_10[i] <- 2017} else 
            if(ext_cycle$PANEL_70[i] > 0 & ext_cycle$PANEL_70[i] <= 2){ext_cycle$NEWINVYR_10[i] <- 2017} else
              if(ext_cycle$PANEL_70[i] > 32 & ext_cycle$PANEL_70[i] <= 35){ext_cycle$NEWINVYR_10[i] <- 2017} else
            
            if(ext_cycle$PANEL_70[i] > 35 & ext_cycle$PANEL_70[i] <= 42){ext_cycle$NEWINVYR_10[i] <- 2018} else 
              if(ext_cycle$PANEL_70[i] > 42 & ext_cycle$PANEL_70[i] <= 49){ext_cycle$NEWINVYR_10[i] <- 2019} else
                if(ext_cycle$PANEL_70[i] > 49 & ext_cycle$PANEL_70[i] <= 56){ext_cycle$NEWINVYR_10[i] <- 2020} else
                  if(ext_cycle$PANEL_70[i] > 56 & ext_cycle$PANEL_70[i] <= 63){ext_cycle$NEWINVYR_10[i] <- 2021} else
                    if(ext_cycle$PANEL_70[i] > 63 & ext_cycle$PANEL_70[i] <= 70){ext_cycle$NEWINVYR_10[i] <- 2022} 
}

table(ext_cycle$INVYR) # Original INVYR distribution
table(ext_cycle$NEWINVYR_10) # New INVYR distribution

# Under this VAE regimen, what prop/pct of plots are measured in each INVYR?
invyrs <- unique(sort(ext_cycle$NEWINVYR_10))
props_measured <- vector(mode = "numeric", length = length(invyrs))
for(i in 1:length(invyrs)){
  props_measured[i] <- nrow(ext_cycle[ext_cycle$NEWINVYR_10==invyrs[i],])/nrow(ext_cycle)
}

round(props_measured*100,2) # 9.99 / 9.90 / 9.99 / 10.13 / 10.09 / 10.02 / 10.06 / 10.06 / 9.86 / 9.90

# For plots getting shifted forward, compute difference in years between original INVYR and new INVYR
#ext_cycle$INVDIFF <- ext_cycle$NEWINVYR_10 - ext_cycle$INVYR_0
ext_cycle$INVDIFF_10 <- ext_cycle$NEWINVYR_10 - ext_cycle$INVYR
table(ext_cycle$INVDIFF_10,useNA = "always") # So in Maine under this case 

ext_cycle$INVDIFF_10 <- ifelse(ext_cycle$INVDIFF_10 < 0, 0, ext_cycle$INVDIFF_10)
ext_cycle$INVDIFF_10 <- ifelse(ext_cycle$INVDIFF_10 > 3, 3, ext_cycle$INVDIFF_10)

table(ext_cycle$INVDIFF_10,useNA = "always") # When positive, plots were pushed forward; when negative, plots were pushed backward
...
for(i in 1:nrow(ext_cycle)){
  if(ext_cycle$PANEL_70[i] > 2 & ext_cycle$PANEL_70[i] <= 7){ext_cycle$NEWINVYR_14[i] <- 2013} else 
    if(ext_cycle$PANEL_70[i] > 7 & ext_cycle$PANEL_70[i] <= 12){ext_cycle$NEWINVYR_14[i] <- 2014} else 
      if(ext_cycle$PANEL_70[i] > 12 & ext_cycle$PANEL_70[i] <= 17){ext_cycle$NEWINVYR_14[i] <- 2015} else 
        if(ext_cycle$PANEL_70[i] > 17 & ext_cycle$PANEL_70[i] <= 22){ext_cycle$NEWINVYR_14[i] <- 2016} else 
          if(ext_cycle$PANEL_70[i] > 22 & ext_cycle$PANEL_70[i] <= 27){ext_cycle$NEWINVYR_14[i] <- 2017} else 
            if(ext_cycle$PANEL_70[i] > 27 & ext_cycle$PANEL_70[i] <= 32){ext_cycle$NEWINVYR_14[i] <- 2018} else
              if(ext_cycle$PANEL_70[i] > 0 & ext_cycle$PANEL_70[i] <= 2){ext_cycle$NEWINVYR_14[i] <- 2019} else
              if(ext_cycle$PANEL_70[i] > 32 & ext_cycle$PANEL_70[i] <= 35){ext_cycle$NEWINVYR_14[i] <- 2019} else
...
round(props_measured*100,2) # 7.24 / 6.94 / 7.13 / 7.10 / 7.22 / 7.15 / 7.31 / 7.19 / 7.24 / 7.06 / 7.21 / 7.01 / 7.10 / 7.10
...
ext_cycle$INVDIFF_14 <- ifelse(ext_cycle$INVDIFF_14 < 0, 0, ext_cycle$INVDIFF_14)
ext_cycle$INVDIFF_14 <- ifelse(ext_cycle$INVDIFF_14 > 7, 7, ext_cycle$INVDIFF_14)

table(ext_cycle$INVDIFF_14,useNA = "always") # When positive, plots were pushed forward; when negative, plots were pushed backward

nsim <- 1000

ext_cycle_results <- data.frame(matrix(NA, nrow = nsim, ncol = 6))
colnames(ext_cycle_results) <- c("total_5","se_pct_5", "total_10","se_pct_10", "total_14","se_pct_14")
...
for(i in 1:nsim){
  ...
  ext_cycle$NEWVOL_5 <- ext_cycle$NEWVOL_10 <- ext_cycle$NEWVOL_14 <- 0
  ...
  # Compute new volumes for 10 year cycle
  ext_cycle$NEWVOL_10 <- ifelse(ext_cycle$PLOT_STATUS_CD==1,
                                ext_cycle$VOLCFNET_plot + (ext_cycle$INVDIFF_10 * growths),
                               0)
  ext_cycle$NEWVOL_10 <- ifelse(ext_cycle$NEWVOL_10 < 0, 0, ext_cycle$NEWVOL_10)
  ...
  NEW_ESTIMATED_TOTAL_10 <- sum(ext_cycle$NEWVOL_10 * ext_cycle$EXPNS)
  ...
  colnames(v_Yhd_new)[ncol(v_Yhd_new)-1] <- "VOLCFNET_eu_strat_se_10"
  ...
  pop_estn_unit_total_new$var_vol_new_10 <- 0
  ...
  for (eu in unique(pop_estn_unit_total$ESTN_UNIT)){
    ...
    # implement GB2 equation 3 page 8 in two parts for this estimation unit
    part1_10 <- sum(with(strata_in_unit,W_h*P2POINTCNT*VOLCFNET_eu_strat_se_10))
    part2_10 <- sum(with(strata_in_unit,(1-W_h)*P2POINTCNT*VOLCFNET_eu_strat_se_10)/n)
    # implement GB2 equation 3 page 8 in two parts for this estimation unit
    ...
    pop_estn_unit_total_new$var_vol_new_10[pop_estn_unit_total_new$ESTN_UNIT==eu] <- (part1_10 + part2_10)/n
  ...
  total_var_new_10 <- sum(pop_estn_unit_total_new$var_vol_new_10*pop_estn_unit_total_new$AREA_USED^2)
  se_new_10 <- sqrt(total_var_new_10)
  ...
  ext_cycle_results$total_10[i] <- NEW_ESTIMATED_TOTAL_10
  ext_cycle_results$se_pct_10[i] <- se_new_10 / NEW_ESTIMATED_TOTAL_10 * 100
...
points(ext_cycle_results$total_10,ext_cycle_results$se_pct_10, pch=19, col = t_grn) # 10 year cycle
...
legend("bottomleft", 
       legend = c("Original Estimate","5 Year Cycle", "10 Year Cycle", "14 Year Cycle"), 
